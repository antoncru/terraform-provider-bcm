		...
		Steps: []resource.TestStep{
			...
			// Import testing.
			{
				...
				ImportStateVerifyIgnore: []string{
					...
					"fips",                   // BCM returns "CATEGORY" when inheriting
					"cmdaemon_url",           // BCM-computed
					"from_template_node",     // BCM-computed
					"index_inside_container", // BCM-computed
					"parent_uuid",            // BCM-computed
					"provisioning_interface", // BCM-computed from interfaces
					"provisioning_transport", // BCM-computed
					"services.#",             // BCM may inject role-based services
